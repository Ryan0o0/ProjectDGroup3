...
public class Camera2_Preview {
    ...
    class C00011 extends StateCallback {
        C00011() {
        }
...
*/
    ...
    class C00022 extends CameraCaptureSession.StateCallback {
        C00022() {
        }
            ...
            if (cameraCacheInfo.characteristics != null) {
                ...
                while (iArr2 < length) {
                    ...
                    if (((Integer) range.getLower()).intValue() < MAX_LOWEST_FPS_ALLOWED) {
                        if (((Integer) range.getUpper()).intValue() < 300) {
...
*/
    ...
    L_0x0129:
        ...
        goto L_0x0135;	 Catch:{ all -> 0x0131 }
    L_0x0131:
