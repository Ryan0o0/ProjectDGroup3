...
public class TrackerManager {
    ...
    public Tracker initTracker(Type type) {
        ...
        type = new Tracker(TrackerManager_initTracker, false);
        if (type.isOfType(ObjectTracker.getClassType())) {
            return new ObjectTracker(TrackerManager_initTracker, false);
        }
        if (type.isOfType(SmartTerrain.getClassType())) {
            return new SmartTerrain(TrackerManager_initTracker, false);
        }
        if (type.isOfType(RotationalDeviceTracker.getClassType())) {
            return new RotationalDeviceTracker(TrackerManager_initTracker, false);
        }
        if (type.isOfType(PositionalDeviceTracker.getClassType()) != null) {
    ...
    public Tracker getTracker(Type type) {
        ...
        type = new Tracker(TrackerManager_getTracker, false);
        if (type.isOfType(ObjectTracker.getClassType())) {
