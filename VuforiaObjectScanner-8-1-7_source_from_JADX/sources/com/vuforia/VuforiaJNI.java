...
class VuforiaJNI {
    ...
    public static final native ByteBuffer GuideView_getName(long j, GuideView guideView);
    ...
    public static final native long ModelRecoSearchResult_SWIGUpcast(long j);

    public static final native long ModelRecoSearchResult_getClassType();

    public static final native float ModelRecoSearchResult_getConfidence(long j, ModelRecoSearchResult modelRecoSearchResult);

    public static final native String ModelRecoSearchResult_getGuideViewName(long j, ModelRecoSearchResult modelRecoSearchResult);
    ...
    public static final native boolean TargetFinder_startInit__SWIG_0(long j, TargetFinder targetFinder, String str, String str2);

    public static final native boolean TargetFinder_startInit__SWIG_1(long j, TargetFinder targetFinder, String str, int i);
    ...
    public static final native void delete_ModelRecoSearchResult(long j);
