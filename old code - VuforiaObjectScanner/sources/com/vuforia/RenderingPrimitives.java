...
public class RenderingPrimitives {
    ...
    public Vec4I getViewport(int i) {
        return new Vec4I(VuforiaJNI.RenderingPrimitives_getViewport(this.swigCPtr, this, i), 1);
    }

    public Vec4F getNormalizedViewport(int i) {
        return new Vec4F(VuforiaJNI.RenderingPrimitives_getNormalizedViewport(this.swigCPtr, this, i), 1);
    }
    ...
    public Vec4F getEffectiveFov(int i) {
        return new Vec4F(VuforiaJNI.RenderingPrimitives_getEffectiveFov(this.swigCPtr, this, i), 1);
    }

    public Vec2F getViewportCentreToEyeAxis(int i) {
        return new Vec2F(VuforiaJNI.RenderingPrimitives_getViewportCentreToEyeAxis(this.swigCPtr, this, i), (boolean) 1);
    }

    public Matrix34F getEyeDisplayAdjustmentMatrix(int i) {
        return new Matrix34F(VuforiaJNI.RenderingPrimitives_getEyeDisplayAdjustmentMatrix(this.swigCPtr, this, i), 1);
    }
    ...
    public Matrix34F getVideoBackgroundProjectionMatrix(int i) {
        return new Matrix34F(VuforiaJNI.RenderingPrimitives_getVideoBackgroundProjectionMatrix__SWIG_1(this.swigCPtr, this, i), 1);
    }

    public Mesh getVideoBackgroundMesh(int i) {
        return new Mesh(VuforiaJNI.RenderingPrimitives_getVideoBackgroundMesh(this.swigCPtr, this, i), 0);
    }

    public Vec2I getDistortionTextureSize(int i) {
        return new Vec2I(VuforiaJNI.RenderingPrimitives_getDistortionTextureSize(this.swigCPtr, this, i), (boolean) 1);
    }

    public Vec4I getDistortionTextureViewport(int i) {
        return new Vec4I(VuforiaJNI.RenderingPrimitives_getDistortionTextureViewport(this.swigCPtr, this, i), 1);
    }

    public Mesh getDistortionTextureMesh(int i) {
        return new Mesh(VuforiaJNI.RenderingPrimitives_getDistortionTextureMesh(this.swigCPtr, this, i), 0);
    }
}
