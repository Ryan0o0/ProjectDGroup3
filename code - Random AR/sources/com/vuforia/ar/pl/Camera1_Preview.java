...
public class Camera1_Preview implements PreviewCallback {
    ...
    class C00661 implements AutoFocusCallback {
        C00661() {
        }
...
*/
    ...
    L_0x0009:
        return r1;
    L_0x000a:
        r2 = r7.requestWidth;	 Catch:{ Exception -> 0x0090 }
        r3 = r7.overrideWidth;	 Catch:{ Exception -> 0x0090 }
        if (r2 != r3) goto L_0x0017;	 Catch:{ Exception -> 0x0090 }
    L_0x0010:
        r2 = r0.getPreviewSize();	 Catch:{ Exception -> 0x0090 }
        r2 = r2.width;	 Catch:{ Exception -> 0x0090 }
        goto L_0x0019;	 Catch:{ Exception -> 0x0090 }
    L_0x0017:
        r2 = r7.overrideWidth;	 Catch:{ Exception -> 0x0090 }
    L_0x0019:
        r7.bufferWidth = r2;	 Catch:{ Exception -> 0x0090 }
        r2 = r7.requestHeight;	 Catch:{ Exception -> 0x0090 }
        r3 = r7.overrideHeight;	 Catch:{ Exception -> 0x0090 }
        if (r2 != r3) goto L_0x0028;	 Catch:{ Exception -> 0x0090 }
    L_0x0021:
        r2 = r0.getPreviewSize();	 Catch:{ Exception -> 0x0090 }
        r2 = r2.height;	 Catch:{ Exception -> 0x0090 }
        goto L_0x002a;	 Catch:{ Exception -> 0x0090 }
    L_0x0028:
        r2 = r7.overrideHeight;	 Catch:{ Exception -> 0x0090 }
    L_0x002a:
        r7.bufferHeight = r2;	 Catch:{ Exception -> 0x0090 }
        r2 = r7.requestFormatAndroid;	 Catch:{ Exception -> 0x0090 }
        r3 = r7.overrideFormatAndroid;	 Catch:{ Exception -> 0x0090 }
        if (r2 != r3) goto L_0x0037;	 Catch:{ Exception -> 0x0090 }
    L_0x0032:
        r0 = r0.getPreviewFormat();	 Catch:{ Exception -> 0x0090 }
        goto L_0x0039;	 Catch:{ Exception -> 0x0090 }
    L_0x0037:
        r0 = r7.overrideFormatAndroid;	 Catch:{ Exception -> 0x0090 }
    L_0x0039:
        r2 = CONVERT_FORMAT_TO_PL;	 Catch:{ Exception -> 0x0090 }
        r2 = r6.translateImageFormat(r0, r2);	 Catch:{ Exception -> 0x0090 }
        r7.bufferFormatPL = r2;	 Catch:{ Exception -> 0x0090 }
...
*/
    ...
    L_0x0090:
        ...
        goto L_0x009b;	 Catch:{ all -> 0x0098 }
    L_0x0098:
    ...
    L_0x00f1:
        ...
        return r2;
    L_0x00f5:
        r8 = r4.camera;	 Catch:{ Exception -> 0x0121 }
        r8.setParameters(r9);	 Catch:{ Exception -> 0x0121 }
